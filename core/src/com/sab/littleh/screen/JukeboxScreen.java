...
public class JukeboxScreen extends Screen {
    ...
    public JukeboxScreen() {
        ...
        playButton = new ImageButton("square_button", "ui/jukebox/play.png",
                new Rectangle(Screen.relZeroX() + 16, Screen.relZeroY() + 16, 80, 88), 8, 16, 64, 64, () -> {
            playSong();
        });
        ...
        buttons.add(new ImageButton("square_button", "ui/jukebox/stop.png",
                new Rectangle(Screen.relZeroX() + 16 + 88, Screen.relZeroY() + 16, 80, 88), 8, 16, 64, 64, () -> {
            stopSong();
        }).setHoverText("Stop"));

        loopButton = new ImageButton("square_button", "ui/jukebox/loop.png",
                new Rectangle(Screen.relZeroX() + 16 + 88 * 2, Screen.relZeroY() + 16, 80, 88), 8, 16, 64, 64, () -> {
            toggleLooping();
        });
        ...
        buttons.add(new ImageButton("square_button", "ui/jukebox/building_song.png",
                new Rectangle(Screen.relZeroX() + 16 + 88 * 3, Screen.relZeroY() + 16, 80, 88), 8, 16, 64, 64, () -> {
        ...
        buttons.add(new ImageButton("square_button", "ui/jukebox/back_arrow.png",
                new Rectangle(Screen.relZeroX() + 16 + 88 * 4, Screen.relZeroY() + 16, 80, 88), 8, 16, 64, 64, () -> {
    ...
    public void render(Graphics g) {
        ...
        g.drawPatch(Patch.get("menu_globbed"), -512 + 32, -Screen.relZeroY() - 178, 512 * 2 - 64, 162, 8);

        g.drawString(jukeboxSongs.get(songIndex).name, LittleH.font, 0, -Screen.relZeroY() - 64, LittleH.defaultFontScale * 1.25f, 0);
        if (jukeboxSongs.get(songIndex).placeholder) {
            g.drawString("-" + jukeboxSongs.get(songIndex).artist, LittleH.font, 0, -Screen.relZeroY() - 102, LittleH.defaultFontScale * 0.9f, 0);
            g.drawString("(Placeholder)", LittleH.font, 0, -Screen.relZeroY() - 136, LittleH.defaultFontScale * 0.7f, 0);
        } else {
            g.drawString("-" + jukeboxSongs.get(songIndex).artist, LittleH.font, 0, -Screen.relZeroY() - 102 - 20, LittleH.defaultFontScale * 0.9f, 0);
        }
