...
import com.sab.littleh.screen.TitleScreen;
...
public class OnlineLevelScreen extends GameScreen {
    ...
    public OnlineLevelScreen(Connection server, int clientNetId, Level level) {
